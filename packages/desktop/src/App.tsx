...
import { ansiToHtml as ansiToHtmlBase, stripAnsi, movePanel, insertPanelRight } from '@ttym/vt';
import {
  MutationBarrier,
  formatCwd,
  memberNameBySession,
...
/** desktop 프리뷰의 기본 전경색만 다르다 — 공유 구현에 위임 */
function ansiToHtml(value: string): string {
  return ansiToHtmlBase(value, { defaultFg: '#d8e4f0' });
}
